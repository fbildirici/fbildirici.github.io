...
<div style="text-align:center;">
  <a href="/assets/images/etc/enx2.jpeg" target="_blank">
    <img 
      data-src="{{ '/assets/images/etc/enx2.jpeg' | relative_url }}" 
      class="lazy rounded-xl"
      style="width: 100%; max-width: 100%; display: inline-block; margin: 0 auto;"
